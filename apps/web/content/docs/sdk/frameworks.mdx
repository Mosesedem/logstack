...
description: Integrate Logstack with Express, Next.js, NestJS, Django, FastAPI, Go net/http, and more.
---
...
Guides for popular stacks. JavaScript examples use **logstack-js**; Python uses
**logstack-py**; Go uses **logstack-go-sdk**.

| Runtime | Package | Full docs |
| --- | --- | --- |
| Node / browser | `logstack-js` | [JavaScript SDK](/docs/sdk/javascript) |
| Go | `logstack-go-sdk` | [Go SDK](/docs/sdk/go) |
| Python | `logstack-py` | [Python SDK](/docs/sdk/python) |
...
Full details: [Python SDK — Django](/docs/sdk/python#django-integration).
...
Full details: [Python SDK — FastAPI](/docs/sdk/python#fastapi--starlette-integration).
...
`source: "go-log"`. See [Go SDK](/docs/sdk/go).
