...
| Date       | Change                                                                                                                                                                                                                                       |
| ---------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-07-10 | **Admin dashboard:** auto-seed `ADMIN_EMAILS` (default `mosesedem81@gmail.com`) on API startup; full admin CRUD for users/projects; role in session + auth redirects (`/continue`, middleware, login → `/admin` for admins); admin UI with create/edit/delete. |
