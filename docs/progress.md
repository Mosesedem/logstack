...
| **SDK publish**           | npm / pypi / go tag                                                                                       | 🔄      | `logstack-js@1.0.1` on npm. Go SDK v1.0.2 fixes lowercase module path for pkg.go.dev (v1.0.1 had `Mosesedem` casing). PyPI `logstack-py` pending upload.                                                                                          |
